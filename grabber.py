...
class Grabber:
    ...
    def __init__(self, suction_motor_id, rotate_motor_id, bottom_switch_id, top_switch_id, _rotate_speed, _suction_speed):
        ...
        self.suction_speed = _suction_speed
    ...
    def execute(self):
        if self.isEngaged:
            self.suction_motor.set(self.suction_speed)
        else:
